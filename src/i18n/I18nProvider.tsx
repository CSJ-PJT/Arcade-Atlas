...
const en: Record<string, string> = {
  ...
  'home.title': 'Start quickly,\nplay to the finish.', 'home.description': 'The Atlas arcade lab—play instantly in your browser.', 'home.inputs': 'Game information', 'home.games': 'Choose a game',
  'home.play': 'Single player', 'home.multiplayer': 'Multiplayer', 'home.upcoming': 'Coming soon', 'home.online': 'Ready to play', 'home.features': 'Game features', 'home.quick': 'Instant play', 'home.controlsShort': 'Keys · touch', 'home.ai': 'Atlas AI match', 'home.mascotAlt': 'Cute energy explorers flying together', 'home.best': 'Best on this device', 'home.players': 'Play style', 'home.singleMulti': 'Solo or together', 'home.gamesHelp': 'Pick a game and jump right in.',
  ...
  'fx.runComplete': 'RUN COMPLETE', 'fx.finish': 'GAME OVER!', 'fx.finalScore': 'Final score {score}', 'fx.energyBurst': 'ENERGY BURST', 'fx.chain': '{chain} CHAIN!', 'fx.cellsCleared': '{count} cells discharged', 'fx.ready': 'READY', 'fx.go': 'GO!', 'fx.stackEnergy': 'Stack the energy', 'fx.itemReady': 'ITEM ACTIVE', 'fx.shieldOn': 'SHIELD ON!', 'fx.blockOne': 'Blocks one gravity pulse', 'fx.perfectGuard': 'PERFECT GUARD', 'fx.blocked': 'ATTACK BLOCKED!', 'fx.shieldSaved': 'The shield protected your board', 'fx.warning': 'WARNING', 'fx.pulseHit': 'GRAVITY PULSE!', 'fx.attackedBy': 'Attack from {name}', 'fx.itemLaunch': 'ITEM LAUNCH', 'fx.pulseSent': 'PULSE FIRED!', 'fx.targeted': 'Hit {name}', 'fx.matchComplete': 'MATCH COMPLETE', 'fx.rankingReady': 'Check the final standings', 'fx.outscore': 'Stack higher than your rivals',
...
const ja: Record<string, string> = {
  ...
  'home.title': 'すぐ始めて、\n最後まで遊ぼう。', 'home.description': 'インストール不要。ブラウザで遊べる Atlas アーケード研究室です。', 'home.inputs': 'ゲーム情報', 'home.games': 'ゲームを選ぶ', 'home.play': 'シングルプレイ', 'home.multiplayer': 'マルチプレイ', 'home.upcoming': '準備中', 'home.online': 'すぐ遊べます', 'home.features': 'ゲームの特徴', 'home.quick': 'すぐ開始', 'home.controlsShort': 'キー · タッチ', 'home.ai': 'Atlas AI 対戦', 'home.mascotAlt': '一緒に飛ぶかわいいエネルギー探検隊', 'home.best': 'この端末の最高得点', 'home.players': 'プレイスタイル', 'home.singleMulti': 'ひとりでも一緒でも', 'home.gamesHelp': '遊びたいゲームを選んですぐに始めよう。',
  ...
  'fx.runComplete': 'RUN COMPLETE', 'fx.finish': 'ゲーム終了！', 'fx.finalScore': '最終スコア {score}', 'fx.energyBurst': 'ENERGY BURST', 'fx.chain': '{chain} CHAIN!', 'fx.cellsCleared': '{count}セル放電', 'fx.ready': 'READY', 'fx.go': 'GO!', 'fx.stackEnergy': 'エネルギーを積み上げよう', 'fx.itemReady': 'ITEM ACTIVE', 'fx.shieldOn': 'シールド発動！', 'fx.blockOne': '重力パルスを1回防御', 'fx.perfectGuard': 'PERFECT GUARD', 'fx.blocked': '攻撃を防御！', 'fx.shieldSaved': 'シールドがボードを守りました', 'fx.warning': 'WARNING', 'fx.pulseHit': '重力パルス！', 'fx.attackedBy': '{name}からの攻撃', 'fx.itemLaunch': 'ITEM LAUNCH', 'fx.pulseSent': 'パルス発射！', 'fx.targeted': '{name}に命中', 'fx.matchComplete': 'MATCH COMPLETE', 'fx.rankingReady': '最終順位を確認しよう', 'fx.outscore': 'ライバルより高く積もう',
